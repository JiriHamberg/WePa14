...
describe "Beerlist page" do
  ...
  it "shows beers in alphabetical order by beer names", :js => true do
    visit beerlist_path
  ...
  it "after clicking 'Style', will show beers in alphabetical order of styles", :js => true do
    visit beerlist_path
    click_on "Style"
  ...
  it "after clicking 'Brewery', will show beers in alphabetical order of breweries", :js => true do
    visit beerlist_path
    click_on "Brewery"
