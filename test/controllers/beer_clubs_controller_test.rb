...
class BeerClubsControllerTest < ActionController::TestCase
  ...
  test "should create beer_club" do
    assert_difference('BeerClub.count') do
      post :create, beer_club: { city: @beer_club.city, founded: @beer_club.founded, integer: @beer_club.integer, name: @beer_club.name, string: @beer_club.string, string: @beer_club.string }
    end
  ...
  test "should update beer_club" do
    patch :update, id: @beer_club, beer_club: { city: @beer_club.city, founded: @beer_club.founded, integer: @beer_club.integer, name: @beer_club.name, string: @beer_club.string, string: @beer_club.string }
    assert_redirected_to beer_club_path(assigns(:beer_club))
  end
