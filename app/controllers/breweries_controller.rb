class BreweriesController < ApplicationController
  ...
  def index
    ...
    case @order
      when "name" then [@active_breweries, @retired_breweries].each { |b| b.sort_by!{|b| b.name} }
      when "year" then [@active_breweries, @retired_breweries].each { |b| b.sort_by!{|b| b.year} }
    end
  end
